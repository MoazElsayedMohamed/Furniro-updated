const Hero = () => {
  return (
    <div className="relative bg-custom-image h-2-screen bg-cover  ">
      <div className="md:absolute md:top-0 md:start-0 w-full h-full flex items-center justify-end px-6 max-lg:px-10 max-md:px-20 max-md:justify-center">
        <div className=" bg-secondary md:w-1/2 xl:w-3/5 p-6 md:p-10 rounded-xl">
